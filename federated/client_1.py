...
class FLClient(fl.client.NumPyClient):
    def __init__(self, data_path):
        ...
        self.kg = build_knowledge_graph(self.df, client_id="client_1")
        self.kg.serialize(destination="data/ttl/client_1.ttl", format="turtle")
...
if __name__ == "__main__":
    fl.client.start_numpy_client(
        server_address="localhost:8080", client=FLClient("data/splits/client_1.csv")
    )
